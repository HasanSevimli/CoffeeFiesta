...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="orange">
          ...
          <li class="' . (strpos($currentPage, 'activeorder.php') !== false ? 'active' : '') . '">
            <a href="./activeorder.php">
              <i class="now-ui-icons shopping_box"></i>
              <p>Siparişlerim</p>
            </a>
          </li>
          <li class="' . (strpos($currentPage, 'product.php') !== false ? 'active' : '') . '">
            <a href="./product.php">
              <i class="now-ui-icons design_bullet-list-67"></i>
              <p>Ürün Listesi</p>
            </a>
          </li>
          <li class="' . (strpos($currentPage, 'feedback.php') !== false ? 'active' : '') . '">
            <a href="./feedback.php">
